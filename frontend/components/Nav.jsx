...
const Nav = () => {
    ...
    <>
      <header
        className={`flex flex-col z-10  w-full justify-between mb-2 md:h-auto md:flex-row ${isMenuOpen ? "h-screen" : "h-auto"}`}
      >
        <div className="w-full flex justify-between md:w-auto bg-primary p-2 py-2.5">
          <div className="max-w-40">
            <Link to=".">
              <img
                className="w-full"
                src="trip-reserve-logo.png"
                alt="TripReserve Logo"
              />
            </Link>
          </div>
          <button
        ...
        <nav
          className={`flex-1 ${isMenuOpen ? "flex" : "hidden"} gap-y-3 flex-col  pl-2 p-3 pb-0 md:flex md:flex-row md:justify-between  bg-primary text-2xl md:text-lg`}
        >
