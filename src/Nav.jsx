...
const Nav = () => {
	...
	<>
			...
			<header className="flex justify-between p-2 pb-0 bg-primary">
				...
				<ul className="flex  justify-center flex-1 text-lg self-end gap-x-2">
					<li><Link to={'/'}>Home</Link></li>
					<li title='Search Flights'><Link to={'/search-flights'} >Flights</Link></li>
					<li><Link to={'/about'}>About Us</Link></li>
				</ul>
				<ul className="flex gap-3.5 items-center pb-4">
					<li><Link to="/help"  className="font-spartan font-[700] text-lg">Help</Link></li>
					{/**Favorite icon comes only after creating the account */}
					{ isAuth && <li>
							<Link to="./saved-flights">
					...
					{!isAuth && <Link to="/signup" className="">Sign Up</Link>}
